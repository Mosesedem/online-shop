...
export default function HomePage() {
  return (
    <main>
      {/* Hero Section */}
      <section className="relative h-screen flex items-center justify-center bg-gradient-to-r from-primary/10 via-primary-light/20 to-primary-dark/10 overflow-hidden">
        <div className="container-max text-center space-y-8 z-10">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Discover our collection of premium adult wear for men and women, plus elegant accessories
          </p>
          <Link href="/shop">
      ...
      <section className="container-max py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-br from-primary/20 to-primary-dark/20 group-hover:from-primary/40 group-hover:to-primary-dark/40 transition-colors" />
